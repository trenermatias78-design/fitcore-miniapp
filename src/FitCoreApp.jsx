...
const EX_TIPS = {
  ...
  "жим в хаммері":             {tip:"Спина притиснута. Лікті трохи нижче плечей. Повний діапазон руху.", video:"/exercises/gifs/жим на груди хаммер.mp4"},
  "жим на груди хаммер":       {tip:"Спина притиснута. Лікті трохи нижче плечей. Повний діапазон руху.", video:"/exercises/gifs/жим на груди хаммер.mp4"},
  "зведення в кросовері":      {tip:"Легкий нахил вперед. Руки злегка зігнуті. Пікове скорочення внизу 1 сек.", video:"/exercises/gifs/зведення рук в кросовері.mp4"},
  "зведення рук в кросовері":  {tip:"Легкий нахил вперед. Руки злегка зігнуті. Пікове скорочення внизу 1 сек.", video:"/exercises/gifs/зведення рук в кросовері.mp4"},
  ...
  "пуловер з гантеллю":        {tip:"Лежачи поперек або вздовж лави. Опускай руки за голову з гантеллю. Акцент на розтяжку грудей та широчайніх.", video:"/exercises/gifs/Пуловер з гантеллю.mp4"},
  ...
  "австралійські підтягування":{tip:"Тіло — пряма лінія. Тягни груди до грифа. Лопатки зводяться наприкінці.", video:"/exercises/gifs/австралійські підтягування.mp4"},
  "тяга верхнього блоку":      {tip:"Легкий відхил назад. Тягни до верхньої частини грудей. Лікті вниз вздовж тулуба.", video:null},
  "вертикальна тяга зворотнім хватом": {tip:"Зворотній хват (долоні до себе). Тягни до верхньої частини грудей. Акцент на біцепс і широчайні.", video:"/exercises/gifs/вертикальна тяга зворотнім хватом в блоці.mp4"},
  "вертикальна тяга хамер":    {tip:"Нейтральний хват. Тягни до грудей. Лікті вниз вздовж тулуба.", video:"/exercises/gifs/вертикальна тяга хамер.mp4"},
  ...
  "горизонтальна тяга в хамер":{tip:"Нейтральний хват. Тягни до поясу. Лопатки зводь у кінцевій точці.", video:"/exercises/gifs/горизонтальна тяга в хамер.mp4"},
  ...
  "екстензія":                 {tip:"Підіймайся до прямої лінії тіла — не вище. Акцент на розгиначах спини. Повільний контрольований рух.", video:"/exercises/gifs/екстензія.mp4"},
  ...
  "зворотні відведення в бабочці": {tip:"Лікті злегка зігнуті. Підйом до рівня плечей. Акцент на задній дельті та ромбоподібних.", video:"/exercises/gifs/зворотні відведення в бабочці.mp4"},
  ...
  "протяжка зі штангою":       {tip:"Хват вузький. Тягни лікті вгору-в сторони вздовж тіла. Не піднімай вище підборіддя. Акцент на середній дельті.", video:"/exercises/gifs/протяжка зі штангою.mp4"},
  ...
  "розгинання на трицепс в блоці": {tip:"Лікті притиснуті до корпусу. Повне випрямлення рук. Пікове скорочення внизу.", video:"/exercises/gifs/розгинання на трицепс в блоці.mp4"},
  "розгинання на трицепс за голови в блоці": {tip:"Лікті нерухомі. Опускай рукоятку за голову. Повне розгинання рук вгорі.", video:"/exercises/gifs/розгинання на трицепс за голови в блоці.mp4"},
  ...
  "фронтальні присідання зі штангою": {tip:"Штанга на передній частині плечей. Лікті вгору паралельно підлозі. Коліна над носками. Спина пряма.", video:"/exercises/gifs/фронтальні присідання зі штангою.mp4"},
  ...
  "присідання в гаак":         {tip:"Плечі притиснуті до валиків. Повний діапазон. Коліна йдуть уздовж стоп.", video:"/exercises/gifs/присідання в гаак.mp4"},
  "зворотні присідання в гаак":{tip:"Спиною до тренажера. Таз назад вниз. Акцент на ягодицях і задній поверхні стегна.", video:"/exercises/gifs/зворотні присідання в гаак.mp4"},
  "присідання колодець":       {tip:"Ноги ширше плечей, носки назовні. Присідай глибоко — акцент на сідницях і привідних. Спина пряма.", video:"/exercises/gifs/присідання колодець.mp4"},
  ...
  "румунська тяга":            {tip:"Спина пряма. Нахил з відведенням таза назад. Відчувай розтяжку задньої поверхні стегна.", video:"/exercises/gifs/Румуньська тяга с гантелями.mp4"},
  ...
  "випади":                    {tip:"Коліно заднє майже торкається підлоги. Переднє коліно над носком. Штовхайся п'ятою.", video:"/exercises/gifs/випад вперед с гантелями.mp4"},
  "випад вперед":              {tip:"Великий крок вперед. Переднє коліно над носком. Штовхайся п'ятою назад.", video:"/exercises/gifs/випад вперед с гантелями.mp4"},
  "випад на місці":            {tip:"Коліно заднє майже торкається підлоги. Переднє коліно над носком. Штовхайся п'ятою.", video:"/exercises/gifs/випад на місці в смітт.mp4"},
  "болгарські присідання":     {tip:"Задня нога на лаві. Передня нога далеко вперед. Опускайся до паралелі.", video:"/exercises/gifs/болгарські присідання.mp4"},
  "підйом на носки":           {tip:"Повний діапазон — від максимального опускання до пальців. Пікове скорочення 1 сек.", video:null},
  "голень сидячи":             {tip:"Підйом на носки сидячи. Акцент на камбалоподібний м'яз. Повний діапазон, пікове скорочення 1-2 сек.", video:"/exercises/gifs/голень сидячи.mp4"},
  ...
  "відведення по одній нозі в блоці": {tip:"Стоячи збоку від блоку. Відводь ногу в сторону — акцент на середній сідничній. Без нахилу корпусу.", video:"/exercises/gifs/відведення по одній нозі в блоці.mp4"},
  "відведення ніг сидячи":     {tip:"Спина пряма. Розводь ноги в сторони — акцент на середній сідничній. Повільне зведення назад.", video:"/exercises/gifs/відведення ніг сидячи.mp4"},
  "зведення ніг в тренажері":  {tip:"Спина притиснута. Зводь ноги разом — акцент на привідних м'язах. Пікове скорочення 1 сек.", video:"/exercises/gifs/зведення ніг в тренажері.mp4"},

  // ── ПРЕС ──
  "скручування":               {tip:"Піднімай лопатки від підлоги. Поясниця притиснута. Видих у верхній точці.", video:"/exercises/video (18).mp4"},
  "скручування на прес":       {tip:"Піднімай лопатки від підлоги. Поясниця притиснута. Видих у верхній точці. Руки в замку за головою.", video:"/exercises/gifs/скручування на прес.mp4"},
  ...
  "підйом ніг лежачи на лавці":{tip:"Поясниця притиснута до лави. Підйом ніг до 90°. Повільне опускання без торкання лави.", video:"/exercises/gifs/підйом ніг лежачи на лавці.mp4"},
  ...
  "мертвий жук":               {tip:"Поперек притиснутий до підлоги. Синхронно опускай протилежну руку і ногу. Не відривай поперек від підлоги.", video:null},
  "bird dog":                  {tip:"На чотирьох. Витягуй протилежну руку і ногу — тіло пряма лінія. Затримка 2 сек. Стабільний таз.", video:null},
  "велосипед":                 {tip:"Поперек притиснутий. Лікоть до протилежного коліна. Пряму ногу витягуй паралельно підлозі. Повільний темп.", video:null},
  "підйом тулуба":             {tip:"Нахил лави. Руки за голову або на грудях. Підіймай до 45°. Контрольоване опускання — повне розгинання.", video:null},
  "russian twist":             {tip:"Відхились трохи назад — відчуй напругу в пресі. Обертай корпус, а не лише руки. Ноги підняті або на підлозі.", video:null},
  "ролик":                     {tip:"На колінах або стоячи. Котись вперед максимально — поперек рівний. Повертайся зусиллям пресу. Не провалюй попереку.", video:null},
  "кут у висі":                {tip:"Тримайся на перекладині. Підіймай ноги до паралелі або вище. Без розгойдування. Контрольоване опускання.", video:null},

  // ── АЛІАСИ ГРУДИ ──
  "жим штанги горизонтально":  {tip:"Лопатки зведені, спина природній прогин. Штанга до нижньої частини грудей. Лікті 45-75°. Негативна фаза 2 сек.", video:"/exercises/video (19).mp4"},
  "жим штанги під кутом":      {tip:"Лава 30-45°. Акцент на верхній частині грудей. Лікті не надто широко.", video:"/exercises/video (29).mp4"},
  "жим штанги негативний":     {tip:"Нахил лави -15-30°. Акцент на нижній частині грудей. Штанга до нижньої частини грудей. Контроль негативної фази.", video:null},
  "жим гантелей горизонтально":{tip:"Гантелі на рівні грудей. На підйомі злегка звужуй. Повний діапазон руху.", video:null},
  "жим гантелей під кутом":    {tip:"Лава 30-45°. Акцент на верхній частині грудей. Лікті не надто широко.", video:"/exercises/video (29).mp4"},
  "жим гантелей негативний":   {tip:"Нахил лави -15-30°. Акцент на нижній частині грудей. Повний діапазон руху.", video:null},
  "жим лежачи":                {tip:"Гантелі або штанга на рівні грудей. Лікті 45-75°. Повний діапазон руху. Негативна фаза 2 сек.", video:null},
  "розведення гантелей":       {tip:"Руки злегка зігнуті. Повільне опускання 3 сек — відчуй розтяжку. Пікове скорочення вгорі 1 сек.", video:null},
  "розведення на підлозі":     {tip:"Руки злегка зігнуті. Повільне опускання — відчуй розтяжку грудей. Пікове скорочення вгорі.", video:null},
  "кросовер":                  {tip:"Легкий нахил вперед. Руки злегка зігнуті. Пікове скорочення в кінцевій точці 1 сек.", video:"/exercises/gifs/зведення рук в кросовері.mp4"},
  "пек-дек":                   {tip:"Спина притиснута до сидіння. Лікті злегка зігнуті. Зводь руки — пікове скорочення 1 сек. Повільне розведення назад.", video:null},
  "відтискання від брусів":    {tip:"Нахил вперед для акценту на груди. Лікті ширше — більше груді, вузько — трицепс. Повне розгинання вгорі.", video:null},
  "відтискання":               {tip:"Тіло — пряма лінія. Лікті 45° від тулуба. Груди торкаються підлоги. Контрольована негативна фаза.", video:"/exercises/video (11).mp4"},
  "пулловер":                  {tip:"Лежачи поперек або вздовж лави. Опускай руки за голову — відчуй розтяжку грудей і широчайніх. Підіймай дугою.", video:"/exercises/gifs/Пуловер з гантеллю.mp4"},

  // ── АЛІАСИ СПИНА ──
  "тяга т-гриф":               {tip:"Нахил 45°, спина пряма. Хват нейтральний або широкий. Тягни до грудей або пупка. Лопатки зводяться в кінці.", video:null},
  "тяга хаммера":              {tip:"Нейтральний хват. Тягни до поясу. Лопатки зводь у кінцевій точці. Не відхиляйся назад.", video:"/exercises/gifs/горизонтальна тяга в хамер.mp4"},
  "тяга в нахилі":             {tip:"Нахил 45°, спина пряма, нейтральний хребет. Тягни до поясу. Лопатки зводяться — не розгойдуй корпус.", video:"/exercises/video.mp4"},
  "пуловер":                   {tip:"Лежачи поперек або вздовж лави. Опускай руки за голову з гантеллю. Акцент на розтяжку грудей та широчайніх.", video:"/exercises/gifs/Пуловер з гантеллю.mp4"},
  "супермен":                  {tip:"Лежачи на животі. Одночасно підіймай руки та ноги від підлоги. Затримка 1-2 сек вгорі. Акцент на розгиначах спини.", video:null},
  "станова":                   {tip:"Спина пряма, нейтральний хребет. Ноги штовхають підлогу. Не округляй поперек. Штанга вздовж ніг.", video:"/exercises/video (6).mp4"},
  "румунська":                 {tip:"Спина пряма. Нахил з відведенням таза назад. Відчуй розтяжку задньої поверхні стегна. Снаряд вздовж ніг.", video:"/exercises/gifs/Румуньська тяга с гантелями.mp4"},

  // ── АЛІАСИ НОГИ ──
  "присід":                    {tip:"Ноги на ширині плечей, носки 30° назовні. Коліна над носками. Спина пряма. Опускайся до паралелі або нижче.", video:"/exercises/video (5).mp4"},
  "гаккеншмідт":              {tip:"Плечі притиснуті до валиків. Повний діапазон руху. Коліна йдуть уздовж стоп.", video:"/exercises/gifs/присідання в гаак.mp4"},
  "гоблет":                    {tip:"Гантель або гиря на рівні грудей. Ноги ширше плечей. Лікті між колінами в нижній точці. Спина пряма.", video:null},
  "болгарський присід":        {tip:"Задня нога на лаві. Передня нога далеко вперед. Опускайся до паралелі — коліно над носком.", video:"/exercises/gifs/болгарські присідання.mp4"},
  "hip thrust":                {tip:"Верхня частина спини на лаві. Штанга над тазом. Підйом — стискай сідниці. Пікове скорочення 2 сек. Поясниця не прогинається.", video:"/exercises/video (16).mp4"},
  "глютеїновий місток":        {tip:"Лежачи на підлозі або з верхньою спиною на лаві. Підйом таза — стискай сідниці. Пікове скорочення 2 сек.", video:"/exercises/video (16).mp4"},
  "махи ногою":                {tip:"Спина пряма. Відводь ногу назад або в сторону — акцент на сідничні. Без прогину в попереку. Контрольоване повернення.", video:null},
  "зашагування":               {tip:"Крок на тумбу або степ. Штовхайся п'ятою робочої ноги. Повне розгинання вгорі. Акцент на квадрицепс і сідниці.", video:null},
  "журавлик":                  {tip:"Одна нога на опорі. Нахил корпусу — тіло і вільна нога паралельно підлозі. Повільний рух. Акцент на задню поверхню стегна.", video:null},
  "крабік":                    {tip:"Присядь до паралелі. Кроки вбік — коліна над носками. Резинка тримає напругу. Не зводь коліна всередину.", video:null},
  "пістолет":                  {tip:"Одна нога витягнута вперед. Опускайся повільно на опорній нозі. Руки вперед для рівноваги. Коліно над носком.", video:null},
  "станова сумо":              {tip:"Широка стійка, носки сильно назовні. Хват між ногами. Спина пряма. Акцент на привідних м'язах і сідницях.", video:null},

  // ── АЛІАСИ ПЛЕЧІ ──
  "жим стоячи":                {tip:"Ноги на ширині плечей. Жим вгору по вертикалі. Корпус не прогинається назад. Напружуй кор.", video:null},
  "жим сидячи":                {tip:"Спина притиснута. Жим вгору по вертикалі. Повний діапазон руху. Не зводь гантелі зверху до стуку.", video:"/exercises/video (24).mp4"},
  "арнольда":                  {tip:"Починай з долонями до себе внизу. На підйомі розвертай зап'ястя — вгорі долоні від себе. Повний діапазон.", video:null},
  "бічні підйоми":             {tip:"Руки злегка зігнуті. Підйом до рівня плечей. Мізинець вище великого пальця. Не розгойдуй корпус.", video:"/exercises/video (3).mp4"},
  "розведення стоячи":         {tip:"Руки злегка зігнуті. Підйом до рівня плечей. Мізинець вище великого пальця. Контрольоване опускання.", video:"/exercises/video (3).mp4"},
  "розведення в нахилі":       {tip:"Нахил 45-90°. Підйом ліктями вгору-назад. Акцент на задній дельті. Контрольоване опускання.", video:"/exercises/video (13).mp4"},
  "підйом перед собою":        {tip:"Рука пряма або злегка зігнута. Підйом до рівня очей. Контрольоване опускання 2-3 сек. Не розгойдуй корпус.", video:null},
  "face-pull":                 {tip:"Тяни до обличчя. Лікті вище плечей. Розвертай плечі назовні в кінці. Пікове скорочення 1 сек.", video:null},
  "face pull":                 {tip:"Тяни до обличчя. Лікті вище плечей. Розвертай плечі назовні в кінці. Пікове скорочення 1 сек.", video:null},

  // ── АЛІАСИ РУКИ ──
  "підйом штанги":             {tip:"Лікті притиснуті. Підйом до повного скорочення. Опускання 2-3 сек. Не відхиляй корпус.", video:"/exercises/video (26).mp4"},
  "ez-штанг":                  {tip:"EZ-штанга зменшує навантаження на запʼястя. Лікті нерухомі. Підйом до повного скорочення. Повний діапазон.", video:"/exercises/video (26).mp4"},
  "підйом гантелей":           {tip:"Лікті нерухомі. Обертай передпліччя під час підйому. Повне розгинання внизу. Акцент на скороченні вгорі.", video:"/exercises/video (1).mp4"},
  "підйом стоячи":             {tip:"Лікті нерухомі. Підйом до повного скорочення. Опускання 2-3 сек. Не розгойдуй корпус.", video:"/exercises/video (1).mp4"},
  "молоток":                   {tip:"Хват нейтральний. Лікті нерухомі. Тягни до плеча. Акцент на брахіаліс і брахіорадіаліс.", video:"/exercises/video (14).mp4"},
  "концентрований":            {tip:"Лікоть притиснутий до коліна. Повне розгинання внизу. Пікове скорочення вгорі 2 сек. Повільне опускання.", video:null},
  "згин на блоці":             {tip:"Стоячи обличчям до блоку. Лікті нерухомі. Підйом до повного скорочення. Повільне опускання.", video:null},
  "кікбек":                    {tip:"Нахил вперед, рука притиснута до корпусу. Розгинай лише передпліччя — лікоть нерухомий. Пікове скорочення в кінці.", video:null},
  "з-за голови":               {tip:"Плечі нерухомі. Опускай за голову — лікті вгорі. Повне розгинання рук вгорі. Контрольоване опускання.", video:null},
  "розгинання на блоці":       {tip:"Лікті притиснуті до корпусу. Повне випрямлення рук. Пікове скорочення внизу. Повільне повернення.", video:"/exercises/video (15).mp4"},
};
