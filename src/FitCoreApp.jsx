...
// ═══ PLAN SELECT ═══
const PLANS_STATIC = {
  start:{name:"START",price:799,stars:500,features:["Тренувальний план","Шаблон харчування","Трекінг прогресу"]},
  premium:{name:"PREMIUM",price:1699,stars:999,features:["Персональний ШІ-план","Чекіни 2×/тиж","Нутріціологія","Фідбек тренера"],hot:true},
  vip:{name:"VIP",price:3499,stars:1999,features:["Повний супровід","Прямий доступ до тренера","Пріоритет","Підтримка 24/7"]},
};
